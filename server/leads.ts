        ...
        if (isWebForm) {
            (async () => {
                try {
                    ...
                    // Reflexion plan attach removed 24 Aug 2026 (dead OpenAI account; atlas step 5).
                } catch (err) {
...
// Test endpoints for the auto-video service removed 24 Aug 2026 (Switchboard Atlas
// review) along with the service itself. Video requests are owned by
// server/post-call-outreach.ts.

// ElevenLabs tool-callback endpoints (/api/eleven-labs/lead, /post-call) deleted 24 Aug 2026
// (atlas step 5) — only the deleted ElevenLabs agent ever called them, and they were
// unauthenticated lead-creation routes.
