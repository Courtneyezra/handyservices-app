...
- Pick the lever from the data: split (2+ lines, £500+, stalled — "start with just the urgent bit, choose what to do now in the link"), reassure (high stakes — lead with the guarantee/fix-it-free), gift_unclaimed (gift claimed or available but never booked — remind them it's waiting), expiry (expiring within 3 days — honest heads-up, no pressure), reminder (everything else).
