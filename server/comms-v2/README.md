...
dates are free, is answered the same way on a booked thread as on any other: the question they
asked is about a new job, not the one already in the diary. A hold on a date change is not a fixed-line hold:
