...
export interface Proposal {
    ...
    ready: boolean;
    /** regulated from Scoping; money beyond a quote line and acceptance in chat from Quoting; a date change or an unconfirmed date from Scheduling. */
    hold: { reason: 'regulated' | 'money' | 'acceptance' | 'draft_failed' | 'stale_quote' | 'date_change' | 'date_unconfirmed'; match: string } | null;
}
