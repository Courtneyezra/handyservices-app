 ...
 * brief, so the board reads a process-local instance of the same sandbox door Goal 1 already built
 * and the pipeline's test step drives - one Desk, one Gateway, one in-memory CaseFileStore, all
 * imported unmodified from server/comms-v2/desk.
 *
