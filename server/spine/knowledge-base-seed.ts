...
export const SEED_FIXED_LINES: KbSeed[] = [
    {
        ...
        approvedWords: "Thanks for getting in touch. We don't take on gas work, so a Gas Safe registered engineer is the one to call for this.\n\nThanks\nBen",
        bannedWords: ['our Gas Safe engineers', 'we can sort the gas', 'I know someone'],
        benNote: 'Sent whole, on its own, whenever gas work comes up, and then the thread is yours. It points them at a Gas Safe registered engineer in general, never at anyone in particular, because there is no partner list. Add one line if you would rather point them somewhere.',
    ...
    },
    {
        ...
        approvedWords: "I'm sorry to hear that. Leave it with me, I'll look into it properly and come back to you personally.\n\nThanks\nBen",
        bannedWords: ['we will put it right free', 'that was our fault', 'we will refund', 'no charge', 'I will be there'],
        benNote: 'Deliberately admits nothing, promises no money and no date, and says only that you are on it. It is what buys you the time to answer properly. Change the words, not the shape.',
    ...
    },
    {
        ...
        approvedWords: "Understood. Let me go through the job and the payment, and I'll come back to you on it personally.\n\nThanks\nBen",
    ...
    },
    {
        ...
        approvedWords: "That's a fair question. Let me get you a proper answer rather than a quick one, and I'll come back to you.\n\nThanks\nBen",
