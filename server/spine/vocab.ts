...
/** P8 Route A: the chain's DRAFT-tier survey offer (the PROPOSE artifacts never reach a pack's intent list). */
export const CHAIN_INTENTS = ['offer_survey'] as const satisfies readonly Intent[];
export const INTENTS = [...RULES_INTENTS, ...SCOPER_INTENTS, ...POST_QUOTE_INTENTS, ...CONTRACTOR_INTENTS, ...CHAIN_INTENTS] as const satisfies readonly Intent[];
