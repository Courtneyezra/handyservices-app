...
import { emailInboundRouter } from './comms-v2/channels/email-inbound';
app.use(emailInboundRouter()); // comms-v2 (Goal 3): inbound email webhook; alive only with COMMS_V2_INTAKE on and its secret set
