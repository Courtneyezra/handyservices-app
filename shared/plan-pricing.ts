...
export const PLAN_ITEMS: PlanItem[] = [
  ...
  { id: "top-stairs", kind: "add", group: "Upstairs", title: "Top of the stairs — wall",
    desc: "Plaster the wall on the right as you reach the top of the stairs, then paper it.", price: 320, labour: 260, materials: 60, days: 1 },
  ...
  { id: "bay-sections", kind: "add", group: "Upstairs", title: "The two re-plastered bay sections",
    desc: "Paper over the two freshly-plastered sections under the bay windows to finish them off.", price: 200, labour: 165, materials: 35, days: 0.5 },
  ...
  { id: "kitchen-grout", kind: "add", group: "Downstairs", title: "Kitchen — re-grout tiles",
    desc: "Rake out and re-grout the kitchen tiling for a clean, fresh finish.", price: 220, labour: 170, materials: 50, days: 1 },
  ...
  { id: "banister", kind: "add", group: "Doors, banister & archway", title: "Staircase banister",
    desc: "Sand, prime and gloss the banister.", price: 190, labour: 160, materials: 30, days: 1 },
