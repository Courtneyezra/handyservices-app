...
export const SEGMENT_HASSLE_MAP: Record<string, HassleComparison[]> = {
  ...
  SMALL_BIZ: [
    {
      id: 'after-hours',
      withoutUs: 'Lose a day\'s trade',
      withUs: 'Work after-hours',
    ...
    {
      id: 'same-day',
      withoutUs: 'Customers see mess',
      withUs: 'Same-day, discreet',
    ...
    {
      id: 'invoicing',
      withoutUs: 'Chase receipts',
      withUs: 'VAT invoice sorted',
