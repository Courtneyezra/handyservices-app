...
export const SEGMENT_HASSLE_MAP: Record<string, HassleComparison[]> = {
  BUSY_PRO: [
    ...
    {
      id: 'direct-line',
      withoutUs: 'Switchboard runaround',
      withUs: 'Direct line to your pro',
  ...
  SMALL_BIZ: [
    {
      id: 'after-hours',
      withoutUs: 'Shut the shop, lose a day\'s takings',
      withUs: 'We work after-hours — zero lost trading',
    ...
    {
      id: 'same-day',
      withoutUs: 'Repairs mid-trade, customers see the mess',
    ...
    {
      id: 'invoicing',
      withoutUs: 'Chase receipts, log expenses by hand',
      withUs: 'VAT invoice same day — accounts-ready',
      whatsappLine: '📄 Proper VAT invoice same day — no chasing',
      vaScript: 'VAT invoice same day — ready for your accounts',
    },
    {
      id: 'cleanup',
      withoutUs: 'Sawdust and tools left on show',
      withUs: 'Spotless cleanup — no trace left',
