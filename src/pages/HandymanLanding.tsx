...
import teamMember4 from "@assets/Untitled design (25)_1764599239599.png";
import teamMember5 from "@assets/Untitled design (26)_1764599239599.png";
import teamMember6 from "@assets/Untitled design (27)_1764599239595.png";
          ...
          {team.map((member, idx) => (
            <div key={idx} className="bg-slate-700/50 rounded-xl md:rounded-3xl p-2 md:p-8 text-center hover:bg-slate-700 transition-colors">
              ...
              <div className="flex items-center justify-center gap-1 md:gap-2 text-amber-400 font-semibold mb-1 md:mb-2">
                ...
                <span className="text-xs md:text-xl">{member.name}</span>
              </div>
    ...
    <section className="bg-slate-700 px-4 lg:px-8 py-16 lg:py-24">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className="text-white/60 text-lg">Skip the hassle. Here's how it works.</p>
        </div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2 text-center lg:text-left">
            ...
            <p className="text-slate-700 text-lg mb-8 max-w-lg mx-auto lg:mx-0">
    ...
    <section id="services" className="bg-white px-4 lg:px-8 py-16 lg:py-24">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 lg:mb-16">
          ...
          <p className="text-slate-600 text-lg">Professional handyman services at transparent prices</p>
        </div>
...
export default function HandymanLanding() {
  return (
    <div className="min-h-screen bg-slate-800">
      <Header />
      <IntakeHero location="Nottingham" source="landing" />
