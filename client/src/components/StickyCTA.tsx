        ...
        <AnimatePresence>
            {isVisible && (
                <motion.div
                    ...
                    className="fixed bottom-0 left-0 right-0 z-[9999] pt-4 lg:hidden"
                >
                    <div className="bg-white/95 backdrop-blur-lg border-t border-slate-200 shadow-2xl overflow-hidden">
