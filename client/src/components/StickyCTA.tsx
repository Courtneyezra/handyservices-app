    ...
    return (
        <AnimatePresence>
            {isVisible && (
                ...
                >
                    <div className="bg-white/95 backdrop-blur-lg border border-slate-200 rounded-2xl shadow-2xl overflow-hidden">
                        {/* Trust Reminder */}
                        <div className="flex items-center justify-center gap-2 py-2 px-3 bg-slate-50 border-b border-slate-100">
                            <Shield className="w-3 h-3 text-[#7DB00E]" />
                            <span className="text-[11px] text-slate-600 font-medium">Just deposit payment to secure your slot</span>
                        </div>
