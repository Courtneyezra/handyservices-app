 ...
 * board by the server. A card selected with no answer showing opens the thread itself
 * (client/src/components/comms-v2/ThreadView.tsx), not a surface mapped here.
 */
import type {
