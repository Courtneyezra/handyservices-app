            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12 lg:mb-16">
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-white">
                        <span className="text-emerald-500">Business-First</span>{" "}
                        <span>Service</span>
                    </h2>
                ...
                <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
                    {steps.map((step, idx) => (
                        <div
                            key={idx}
                            className={`relative p-8 lg:p-10 rounded-3xl text-center ${step.highlight ? "bg-emerald-600 text-white" : "bg-slate-700 text-white"
                                }`}
                        >
                            <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-3xl font-bold ${step.highlight ? "bg-white text-emerald-600" : "bg-slate-600 text-white"
                                }`}>
                                {step.number}
                            </div>
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12 lg:mb-16">
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4">
                        ...
                        <span className="text-emerald-600">Maintenance</span>
                    </h2>
                ...
                <div className="text-center mt-16">
                    <a href="#hero" className="scroll-smooth">
                        <Button
                            className="px-10 py-6 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-full text-lg"
                        >
                            Get Business Quote
                            <ArrowRight className="w-5 h-5 ml-2" />
                        </Button>
...
export default function BusinessLanding() {
    ...
    // Dedicated Business Content
    const finalHeadline = "Keep your business open and running.";
    const finalSubhead = "Discreet repairs, out-of-hours service, and 30-day payment terms.";
