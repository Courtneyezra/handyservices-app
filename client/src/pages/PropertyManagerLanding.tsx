            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
                    {steps.map((step, idx) => (
                        <div
                            key={idx}
                            className={`relative p-8 lg:p-10 rounded-3xl text-center ${step.highlight ? "bg-blue-600 text-white" : "bg-slate-700 text-white"
                                }`}
                        >
                            <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-3xl font-bold ${step.highlight ? "bg-white text-blue-600" : "bg-slate-600 text-white"
                                }`}>
                                {step.number}
                            </div>
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
                    {services.map((service, idx) => (
                        <div
                            key={idx}
                            className="bg-slate-50 rounded-3xl p-8 relative group hover:shadow-xl transition-all duration-300 border border-slate-100"
                        >
                            ...
                            <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-slate-800 text-white text-sm font-bold px-5 py-2 rounded-full shadow-lg">
                                From {service.price}
                            </div>
                        </div>
                    ))}
                ...
                <div className="text-center mt-16">
                    <a href="#hero" className="scroll-smooth">
                        <Button
                            className="px-10 py-6 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-full text-lg"
                        >
                            Get A Quote
                            <ArrowRight className="w-5 h-5 ml-2" />
                        </Button>
...
export default function PropertyManagerLanding() {
    ...
    // Merge props with variant data (props take precedence if provided, otherwise fallback to variant or default)
    // Dedicated Property Manager Content
    const finalHeadline = "One trusted vendor for all your units.";
    const finalSubhead = "From GSC to leaks, we handle it all. Key pickup available.";
    ...
    return (
        <div className="min-h-screen bg-slate-50 font-poppins text-slate-900 font-medium">
            ...
            <JsonLd data={serviceSchema({ trade: 'Property Maintenance', city: 'Nottingham' })} />
            ...
            <div className="bg-slate-900 pt-8 pb-16">
                {/* Quick stats or trust badges could go here */}
            </div>
