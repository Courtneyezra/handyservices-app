        ...
        <main className="mx-auto max-w-3xl px-6 py-12">
            ...
            <Section title="Who we share it with">
                ...
                <ul className="list-disc space-y-1 pl-5">
                    ...
                    <li><strong>Anthropic</strong> — the assistant that reads our messages and drafts replies runs on Anthropic's Claude models. Your messages, your name and phone number, the job details, a summary of any call, and the description of any photo or video you send are sent to Anthropic so it can understand your enquiry and write a reply. If you are already a customer, the details of your past enquiries, quotes, bookings and invoices (their status, dates and amounts, but not your email or postal address) are sent too, so it can answer questions about them. The model that writes the reply, Fable 5.1, keeps what it receives for up to 30 days under Anthropic's own terms.</li>
