...
import teamMember1 from "@assets/Untitled design (22)_1764599239600.png";
import teamMember2 from "@assets/Untitled design (23)_1764599239600.png";
import teamMember3 from "@assets/Untitled design (24)_1764599239599.png";
import heroImage from "@assets/f7550ab2-8282-4cf6-b2af-83496eef2eee_1764599750751.png";
import videoQuoteImage from "@assets/123d3462-a11d-42b8-9fad-fdb2d6f29b11_1764600237774.png";
import handyLogo from "@assets/Copy of Copy of Add a heading-3_1764600628729.png";
import mobileHeroImage from "@assets/f7550ab2-8282-4cf6-b2af-83496eef2eee_1764604328714.png";
import realJobToilet from "@assets/c33e343a-3b9d-4d85-97cb-a0752ea3e80d_1764687156907.png";
import realJobPainting from "@assets/97e1a436-81fd-44d2-8b08-ce5a374c9c4b_1764687156908.png";
import realJobSink from "@assets/cf7cd976-8854-4abb-a7dd-391a08c63978_1764687156908.png";
import realJobShelf from "@assets/c2f4951d-baa5-4a9f-8b4e-233fa5fcb49c_1764687156908.png";
import realJobKitchen from "@assets/4cc2f0fa-125e-412b-9929-4e03a055b760_1764687156909.png";
import realJobBlinds from "@assets/528c52d4-f8ff-4e5b-9853-b68263a62c2f_1764694548068.png";
import beforeImage from "@assets/74cb4082-17d2-48b1-bd98-bf51f85bc7a5_(1)_1764694445995.png";
import afterImage from "@assets/cb5e8951-9d46-4023-9909-510a89d3da60_1764693845208.png";
import payIn3Image from "@assets/6e08e13d-d1a3-4a91-a4cc-814b057b341d_1764693900670.png";
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div className="text-center lg:text-left">
                        ...
                        <div className="inline-flex items-center gap-2 bg-amber-400/20 px-4 py-2 rounded-full mb-6">
                            ...
                            <span className="text-amber-400 font-medium text-sm">Trusted by 200+ Derby Homeowners</span>
                        </div>

                        <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight font-poppins">
                            Next-Day<br /><span className="text-amber-400">Handyman Service</span><br />in Derby
                        </h1>
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12 lg:mb-16">
                    ...
                    <p className="text-white/60 text-lg max-w-2xl mx-auto font-medium">
                        Meet our trusted professionals who've helped hundreds of Derby homeowners
                    </p>
                </div>
...
function RealJobsSection() {
    const customers = [
        ...
        { name: "Craig", area: "DE24", job: "Kitchen cabinet fitting", image: realJobKitchen },
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mt-8">
                    <p className="text-slate-800 italic text-lg">
                        "Jane, DE1 - requested a kitchenette to be removed and a unit with a sink built. 2 days to complete and a happy customer!"
                    </p>
                </div>
            </div>
        </section>
...
function TestimonialsSection() {
    const testimonials = [
        { name: "Sarah M.", area: "DE1", text: "Absolutely brilliant service. Richard was punctual, professional and did an amazing job on our bathroom. Would highly recommend!", rating: 5 },
        { name: "James T.", area: "DE21", text: "Used Handy Services for multiple jobs now. Always reliable, fair prices and great quality work. Won't go anywhere else.", rating: 5 },
        { name: "Michelle K.", area: "DE23", text: "Barry fitted our new kitchen cabinets perfectly. Clean, tidy and finished ahead of schedule. 5 stars!", rating: 5 },
    ];
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-12 lg:mb-16">
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-800 mb-4">
                        What Derby <span className="text-amber-500">Says About Us</span>
                    </h2>
            ...
            <div className="max-w-4xl mx-auto text-center">
                ...
                <div className="border-t border-white/10 pt-8">
                    <p className="text-white/40 text-sm">
                        © 2024 Handy Services Derby. All rights reserved.
                    </p>
                </div>
            </div>
        </section>
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="order-1 lg:order-2 text-center lg:text-left">
                        ...
                        <p className="text-white/70 text-lg mb-8">
                            Choose sustainable solutions that reduce your energy bills and environmental impact. From water-saving fixtures to draught-proofing, we help make your Derby home greener.
                        </p>
