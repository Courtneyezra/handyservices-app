...
Quoting specialist and its tool server under `server/comms-v2/quoting/`, and Goal 5's
...
by contract with its sandbox door and that door's quoting and scheduling fixtures, the door host and the
